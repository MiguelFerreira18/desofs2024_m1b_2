...
public class EncomendaSaveDTOService {
    ...
    public EncomendaSaveDTOService(int mealsPerWeek, int numberOfPeople, double price, LocalDateTime dataEncomenda, Pacote pacote, Estado estado, User user) {
